...
uses
  ...
  Datasnap.DSHTTP, DS.Services.Pessoa, System.JSON, Data.DBXCommon;
...
type
  TWebModule1 = class(TWebModule)
    ...
    dsServerPessoa: TDSServerClass;
    ServiceEndereco: TDSServerClass;
    ...
    procedure dsServerPessoaGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
    procedure DSRESTWebDispatcher1FormatResult(Sender: TObject;
      var ResultVal: TJSONValue; const Command: TDBXCommand;
      var Handled: Boolean);
    procedure ServiceEnderecoGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
  private
...
uses ServerMethodsUnit1, Web.WebReq, DS.Services.Endereco;
...
procedure TWebModule1.dsServerPessoaGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := DS.Services.Pessoa.TPessoaService;
end;
...
procedure TWebModule1.ServiceEnderecoGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := DS.Services.Endereco.TEnderecoService;
end;
